...
async def update_data(id: PydanticObjectId, req: UpdateProductReview) -> ProductReview:
...
@router.delete("/{id}", response_description="Review record deleted from database")
async def delete_data(id: PydanticObjectId) -> dict:
